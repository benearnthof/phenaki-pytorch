...
from phenaki_pytorch.frozen_models.pytorch_i3d.pytorch_i3d import InceptionI3d
...
class CViViT(nn.Module):
    def __init__(
        ...
        *,
        ...
        vgg=None,
        i3d_model_path='/workspace/phenaki-pytorch/phenaki_pytorch/frozen_models/pytorch_i3d/models/rgb_imagenet.pt',
